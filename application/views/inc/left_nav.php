<!-- START LEFT SIDEBAR NAV -->
      <aside id="left-sidebar-nav">
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
              ...
              <li class="bold"><a href="<?=base_url('sys/candidates/')?>" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Candidates</a></li>       
              <li class="bold"><a href="<?=base_url('sys/voting/voting_passes/')?>" class="waves-effect waves-cyan"><i class="mdi-action-receipt"></i> Voting Passes</a></li> 
              ...
              <li class="li-hover"><div class="divider"></div></li>
              <li class="bold"><a href="<?=base_url('sys/dashboard/logout')?>"><i class="mdi-action-lock"></i>Logout</a>
                              </li>
          </ul>         
