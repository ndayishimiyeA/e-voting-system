...
<html lang="en">
  ...
  <body class="grey lighten-5">
    ...
    <div class="col s12 m8 l6 z-depth-4 card-panel rpf-stripe vote-container">
      ...
      <h1 class="center col s12" style="color: #00c853; "> <?=$page_data['title']?> </h1>
      <div class="center"> <?=$page_data['value']?> <p class="counter-txt">Ikigikorwa cyirasozwa mama sekonda <span id='redirect-countdown'></span> Murakoze.
        </p>
      </div>
