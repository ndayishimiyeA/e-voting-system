...
<html lang="en">
  ...
  <body class="grey lighten-5">
    ...
    <div class="col s12 m8 l6 z-depth-4 card-panel rpf-stripe vote-container">
      ...
      <h4 class="header"> <?=$page_data['title']?> </h4>
      <!-- /.header -->
      <div class="row">
        <div class="col s12"> <?=$page_data['value']?> </div>
        <!-- /.col s12 -->
      </div>
      <!-- /.row -->
      <div class="row valign-wrapper">
        <a href="
                                  <?=base_url('login')?>" class="btn waves-effect rpf-blue accent-2 col s5 offset-s4">Komeza </a>
