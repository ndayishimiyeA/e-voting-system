                  ...
                  <?=form_open_multipart('sys/candidates/update/' . $info['id'], array('class' => 'card-content'))?>
                       ...
                       <div class="row">
                          <div class="input-field col s12">
                                  <button class="btn green accent-4 waves-effect waves-light right" type="submit" name="action">Update
                       ...
                       <div class="row">
                         <div class="input-field col s12">
                           <a href="#deleteModal" id ="admin-delete-candidate-Modal" class="modal-trigger btn waves-effect red right">Delete <i class="mdi-action-delete right"></i></a>
           ...
           <div id="deleteModal" class="modal">
              <?=form_open('sys/candidates/delete')?>
                <div class="modal-content">
                    <p>Are you sure to delete the record of <span class="strong"><?=$info['name']?></span>? You <span class="strong red-text">CANNOT UNDO</span> this action.</p>
                    <input type="hidden" name="id" value="<?=$this->encryption->encrypt($info['id'])?>" />
                  </div>
