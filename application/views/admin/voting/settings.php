        ...
        <div class="container">
                ...
                <div class="card">
                  <div class="card-content">
                    ...
                    <div class="row">
                      ...
                      <div class="col s7">
                        <a href="#clearVote" id="clear-votes-modal" class="btn waves-effect waves-light amber modal-trigger"><i class="mdi-action-delete left"></i> Clear Votes</a>
                      </div><!-- /.col s7 -->
                    </div><!-- /.row -->
                    <br />
                    <div class="row">
                      ...
                      <div class="col s7">
                        <a href="#resetDefault" id="reset-settings-modal" class="btn waves-effect waves-light red modal-trigger"><i class="mdi-notification-sync-problem left"></i> Reset to Default Settings</a>
                      </div><!-- /.col s7 -->
                    </div><!-- /.row -->
                  </div><!-- /.card-content -->
                </div><!-- /.card -->
          ...
          <div id="clearVote" class="modal">       
            ...
            <div class="modal-content">
              <h5 class="center">Are you sure to <strong >Clear All Votes?</strong></h5>
              <p class="center"> 
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="waves-effect waves-green btn-flat modal-action red white-text">Agree</button>
            </div>
            <?=form_close()?>
          </div>
          ...
          <div id="resetDefault" class="modal">      
            <?=form_open('sys/voting/settings')?>    
            <div class="modal-content">
              <h5 class="center">Are you sure to <strong>Reset to Default?</strong></h5>
              <p class="center"> 
                  Resetting the Voting System to default will <strong class="red-text">DELETE ALL VOTES</strong>, <strong class="red-text">VOTING PASSES</strong>, <strong class="red-text">CANDIDATES</strong>, <strong class="red-text">POSITIONS</strong>, <strong class="red-text">YEARS</strong>, <strong class="red-text">COURSES</strong> and , <strong >REPLACES the PAGES with its Defaults</strong>. This may compromise your on-going Voting event, and only suitable for re-voting purposes.               
              </p><!-- /.center -->
              <p class="center red-text strong">THIS ACTION CANNOT BE UNDONE.</p><!-- /.center red-text strong -->             
              <p class="center">Please input your password to continue.</p><!-- /.center -->
              <div class="row">
            ...
            <div class="modal-footer">
              <a href="#" class="waves-effect waves-red btn-flat modal-action modal-close ">Disagree</a>
              <button type="submit" class="waves-effect waves-green btn-flat modal-action white-text red">Agree</button>
            </div>
            <?=form_close()?>
          </div>
