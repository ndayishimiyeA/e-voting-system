...
<body>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <div class="col s6">    <button class="btn rpf-blue waves-effect waves-light right" type="submit" name="action">Update
                                <i class="mdi-editor-mode-edit left"></i>
                              </button></div>
      <div class="col s6">
        <a href="#resetModal" class="modal-trigger btn waves-effect green right" id="admin-reset-user-password-Modal">Password Reset <i class="mdi-action-cached left"></i></a>
      </div>
    </div>
