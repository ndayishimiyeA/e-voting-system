    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
           ...
           <div class="row card ">
              <div class="col s12">       
                <div class="card-content">
                  ...
                  <p>Generating voting passes may disrupt the on-going voting event. The system will <span class="red-text strong">DELETE ALL VOTES</span> and existing 
                  <span class="red-text strong">VOTING PASSES</span>, and generate a new set of keys.</p><!-- /.white-text -->
                </div>
                <div class="card-action">
                  <div class="row">
                    <a href="#generateModal" id="admin-generate-voting-code-Modal" class="modal-trigger btn waves-effect green accent-4 white-text right">Generate <i class="mdi-action-autorenew right"></i></a>
                ...
                <div class="modal-content">
                    <div class="row">
                      ...
                      <div class="col s12 m12 l12 black-text">
                        ...
                        <p>The system will <span class="red-text strong">DELETE ALL VOTES</span> and existing <span class="red-text strong">VOTING PASSES</span>. This action cannot be <span class="strong red-text">UNDONE.</span></p>
                  ...
                  <div class="modal-footer">
                    <a href="#" class="waves-effect waves-red btn-flat strong modal-action modal-close">Cancel</a>
          ...
          <div class="section">
            <div class="row rpf-blue">
              <div class="col s12">
                <h6 class="white-text"><span class="strong">Claimed Passes</span> <span class="right"><?=$total_passUsed?>/<?=$total_passes?></span></h6>
                  <div class="progress">
                    <div class="determinate" style="background-color: #ff0000; width: <?=round(($total_passUsed / $total_passes)*100)?>%"></div>   
                  </div>
              </div><!-- /.col s12 -->
            </div><!-- /.row -->
