...
<body class="grey lighten-5">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel rpf-stripe">

      <?=form_open('sys/dashboard/login', array('class' => 'login-form'))?>
        <div class="row">
          <div class="input-field col s12 center">
            <img src="<?=base_url()?>assets/images/logofooter.png" alt="" class="responsive-img valign">
            <p class="center login-form-text"><?=$site_title?></p>
          </div>
        </div>
        <div class="row margin center hideMe">  
        ...
        <div class="row">
          <div class="input-field col s12">
            <button type="submit" class="btn waves-effect rpf-blue darken-3 col s12">Login</button>
          </div>
        </div>        
      </form>
    ...
    <script type="text/javascript" src="<?=base_url('assets/js/admin_script.js')?>"></script>
